...
namespace FSMCharacterController
{
    ...
    /// </summary>
    public class MovementState_Run : MovementState
    {
        ...
        public override void Enter()
        {
            ...
            _playerSpeed = _playerControlSettings.RunningSpeed;
        ...
        public override void Execute()
        {
            ...
            _fsmManager.MovementManager.SetMovementDirection(_fsmManager.PlayerMovementDirection, _currentSpeed);
